...
public interface IMCLVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code assignVariable} labeled
	...
	/**
	 * Visit a parse tree produced by the {@code assignFunction} labeled
	 * alternative in {@link IMCLParser#assignDefine}.
	 * 
	 * @param ctx the parse tree
	 * @return the visitor result
	...
	/**
	 * Visit a parse tree produced by the {@code assignInvoke} labeled
	 * alternative in {@link IMCLParser#assignDefine}.
	 * 
	 * @param ctx the parse tree
	 * @return the visitor result
	...
	/**
	 * Visit a parse tree produced by the {@code assignReturn} labeled
	 * alternative in {@link IMCLParser#assignDefine}.
	 * 
	 * @param ctx the parse tree
	 * @return the visitor result
	...
	/**
	 * Visit a parse tree produced by the {@code assignStop} labeled alternative
