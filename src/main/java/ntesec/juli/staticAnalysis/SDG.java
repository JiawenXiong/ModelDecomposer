...
public class SDG {
	...
	public static Map<String, Set<Integer>> InterSDG = new HashMap<>(); // 用来记录程序块之间的映射：<"main:function1",
																		// {1,
																		// 3,
																		// 4}>
	...
	public static Map<String, Set<Integer>> combinedPDGs(
			Map<String, List<Statement>> mapPDGs) {
		/** 放在后续合并两个程序块时候 */
